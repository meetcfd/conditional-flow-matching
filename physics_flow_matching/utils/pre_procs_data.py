import torch as th
from torchcfm.conditional_flow_matching import FlowMatcher, RectifiedFlow
from typing import Union

def get_batch(FM : Union[FlowMatcher, RectifiedFlow], x0 : th.Tensor, x1 : th.Tensor, return_noise=False):
