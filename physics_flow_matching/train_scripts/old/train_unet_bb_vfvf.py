...
def main(config_path):
    ...
    train_dataloader = get_loaders_vfvf(config.dataloader.u_inpp,
                                        config.dataloader.u_outp,
                                        config.dataloader.v_inpp,
                                        config.dataloader.v_outp,
                                        config.dataloader.w_inpp,
                                        config.dataloader.w_outp,
