...
np.save("/ehome/yaqin/conditional-flow-matching/physics_flow_matching/multi_fidelity/analysis/inverse_problems/turb/meas_func2/dpmcstep100noise.npy", samples_cond_grad_dpmc)