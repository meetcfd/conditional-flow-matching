...
# %%
np.save("/ehome/yaqin/conditional-flow-matching/physics_flow_matching/multi_fidelity/analysis/inverse_problems/KS-equation/meas_func1/flow_dapsstep200noise.npy", samples_daps)
