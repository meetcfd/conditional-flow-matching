...
exp = 5
iteration = 9
ot_cfm_model = UNetModel(dim=[3, 32, 32],
...
# %%
coords = np.random.choice(320*200, size = 10000)
coord1 = coords % 320
coord2 = coords // 320
...
# %%
np.save(f"/home/meet/FlowMatchingTests/conditional-flow-matching/physics_flow_matching/vf_fm/exps/low_wave_recons/exp_{exp}/samples_{iteration}iter_500_y{yp[yp_ind]}_test_cond", samples)
