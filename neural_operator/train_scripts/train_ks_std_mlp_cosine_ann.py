...
from neural_operator.utils.dataloader import get_loaders_noise_inj
from neural_operator.utils.train_std_cosine_ann import train_model
...
def main(config_path):
    ...
    train_dataloader, test_dataloader = get_loaders_noise_inj(config.dataloader.datapath,
    ...
    sched = CosineAnnealingLR(optim, T_max=config.scheduler.T_max, eta_min=config.scheduler.eta_min)
